...
$query="Select ID,NAME,VALUE,BPM from user_chords where ID_USER=".$_SESSION['userId'];
...
echo "<div class='container-fluid' align=center style='display:inline-block;'>
            ...
            <div class='card-title'><strong> My Chord Progressions </strong></div>
                ...
                while ($row = mysqli_fetch_array($answer)) {
					...
					<button type='button' style='' onclick ='location.href=\"index.php?chordsToLoad=".$row['VALUE']."&BPM=".$row["BPM"]."\"' class ='btn btn-light'>".$row['NAME']."</button>
